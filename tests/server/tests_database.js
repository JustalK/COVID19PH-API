...
test('[STATIC] Testing parse_db_uri with correct value', async t => {
...
test('[STATIC] Testing create_mongo_uri with correct value', async t => {
...
test('[STATIC] Testing create_mongo_uri with different correct value', async t => {
	const db_data_uri = m.create_mongo_uri({
		db: 'my_db',
		host: '192.168.1.26',
		port: '26920',
